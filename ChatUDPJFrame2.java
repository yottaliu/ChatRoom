...
public class ChatUDPJFrame extends JFrame implements ActionListener
{
    ...
    public void firstTime()
    {
        ...
        // 切换局域网中下一台主机需要的变化量的值
        delta = 1 << networkPrefixLength;
        // 网络前缀
        networkPrefix = localip & (delta - 1);
        // 局域网中第一台主机的主机号
        begin = delta;
        // 局域网中最后一台主机之后的主机号，一般为直接广播地址的主机号
        end = ~(delta - 1);
        ...
        System.out.println("networkPrefixLength: " + networkPrefixLength);
        ...
        */
        ...
        // 给局域网所有主机发消息
        sendToAll(alertBuffer);
        //text_receiver.append("目前在线的网友有：\n");
    }

    /**
     * 把字节流缓冲区buffer的内容发给局域网所有主机
     */
